<%-- 
    Document   : vehicle_edit
    Created on : 20 Jan 2026, 9:10:28 pm
    Author     : SHAHRUL
--%>
...
<head>
  ...
  <title>Edit Vehicle | Smart Campus</title>
  ...
  <style>
    ...
    .imgbox{border:1px solid #eef0f6;border-radius:18px;overflow:hidden;background:#f9fafb}
    .imgbox img{width:100%;height:260px;object-fit:cover;display:block}
  </style>
</head>
      ...
      <div class="content">
        <div class="page-head">
          <div>
            ...
            <div class="muted">Update your vehicle details and grant image.</div>
          </div>
        ...
        <div class="cardx">
          <form method="post" action="<%=request.getContextPath()%>/student/vehicle/edit" enctype="multipart/form-data">
              ...
              <div class="col-lg-7">
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" value="<%= v.getVehicleType() %>" disabled>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Plate Number</label>
                    <input class="form-control" value="<%= v.getPlateNumber() %>" disabled>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" value="<%= v.getBrand() %>" disabled>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label class="form-label fw-bold">Color <span style="color:#6f3cff;font-size:12px">(Editable)</span></label>
                    <input name="color" class="form-control" value="<%= v.getColor() %>" required
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" value="<%= v.getEngineCC() %>" disabled>
                </div>

                <div class="mb-3 p-3" style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:14px">
                  <div style="font-size:12px;font-weight:900;color:#15803d;margin-bottom:4px">ℹ️ Edit Policy</div>
                  <div style="font-size:13px;font-weight:600;color:#166534">
                    Only the vehicle <b>color</b> can be updated. Other details such as vehicle type, plate number, brand, and engine CC are fixed after registration. The vehicle status will remain unchanged.
                  </div>
                </div>

                <button class="btn-purple" type="submit">Update Color</button>
              </div>

              <div class="col-lg-5">
                <div class="muted mb-2">Current Grant Image</div>
                <div class="imgbox">
                  <img src="<%= imgUrl %>" alt="Grant Image">
                </div>
                <div class="mt-3 muted">
                  Vehicle ID: <b><%= v.getVehicleId() %></b><br>
                  Status: <b><%= (v.getStatus()==null?"PENDING":v.getStatus()) %></b>
                </div>
              </div>
            </div>
          </form>
