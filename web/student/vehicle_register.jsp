<%-- 
    Document   : vehicle_register
    Created on : 20 Jan 2026, 3:51:44 pm
    Author     : SHAHRUL
--%>
...
<head>
  ...
  <title>Register Vehicle | Smart Campus</title>
      ...
      <div class="content">
        <div class="page-head">
          <div>
            ...
            <div class="muted">Submit your vehicle details. Status will be <b>PENDING</b> until clerical approves.</div>
          </div>

          <a class="btn-soft" href="<%=request.getContextPath()%>/student/vehicles">
            Back to Vehicles
          </a>
        </div>
        ...
        <div class="cardx">
          <form method="post" action="<%=request.getContextPath()%>/student/vehicle/register" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input name="plateNumber" class="form-control" placeholder="TAV 1234" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input name="brand" class="form-control" placeholder="Perodua Myvi" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label fw-bold">Color</label>
                <input name="color" class="form-control" placeholder="White" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input name="engineCC" class="form-control" placeholder="1.3 / 150" required>
              </div>
              <div class="col-md-6 mb-3">
                <label class="form-label fw-bold">Grant Image</label>
                <input name="grantImage" type="file" class="form-control" accept="image/*" required>
                <div class="form-text">Upload grant (image). Max 5MB.</div>
              </div>
            </div>
